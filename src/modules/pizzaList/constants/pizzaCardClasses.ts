...
export const classes = {
    cardWrapper: "max-w-xs rounded-md tablet:max-w-tablet-card phone:max-w-phone-card",
    image: "w-5/6 px-4 pt-4 mx-auto",
    infoWrapper: "px-4",
    name: `${fontFamily} ${semibold} laptop:text-lg max-w-14em tablet:text-md`,
