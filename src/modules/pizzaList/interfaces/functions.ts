...
interface ReducerFunction extends ActionCreatorWithPayload<any, string> { (arg: any): any };

//Можно будет расширить
interface AsyncFunction extends AsyncThunkAction<any, string, any> { (arg: any): any}
...
export type HighOrderFunctionForStore = HighOrderFunction<HighOrderFunctionForStoreCallbacks | any>
